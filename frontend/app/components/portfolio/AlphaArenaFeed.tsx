    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      >
        ...
        <div className="flex-1 border border-t-0 border-border bg-card min-h-0 flex flex-col overflow-hidden">
          {/* Always render error div to maintain hooks consistency */}
          <div className="p-4 text-sm text-red-500" style={{ display: error ? 'block' : 'none' }}>
            {error}
          </div>

          {/* Always render TabsContent to maintain hooks consistency */}
          <div style={{ display: error ? 'none' : 'flex' }} className="flex-1 flex flex-col">
